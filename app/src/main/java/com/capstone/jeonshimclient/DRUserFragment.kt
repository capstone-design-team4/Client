...
import kotlinx.android.synthetic.main.fragment_druser.*

class DRUserFragment : Fragment() {
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        // Inflate the layout for this fragment
        return inflater.inflate(R.layout.fragment_druser, container, false)
    }
    ...
    fun fragmentBasic(){
        ...
        user_set.color = ContextCompat.getColor(requireContext(), R.color.gray_1)
