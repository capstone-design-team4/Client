...
class DRUserAdapter  (private val context: Context) : RecyclerView.Adapter<DRUserAdapter.ViewHolder>() {

    var datas = mutableListOf<DRUserData>()
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(context).inflate(R.layout.drgraph_recycler_ex,parent,false)
    ...
    inner class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun UserDRGraph(context: Context){
            ...
            val user_set = BarDataSet(user_entries,"예상 사용량") // 데이터셋 초기화

            user_set.color = ContextCompat.getColor(context,R.color.teal_200)
        ...
        fun bind(item: DRUserData) {
            // 범석님 get값 넣으실 때 여기에 넣어주시면 됩니다
